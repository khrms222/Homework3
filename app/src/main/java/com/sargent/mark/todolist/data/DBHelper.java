...
public class DBHelper extends SQLiteOpenHelper{
    ...
    /*
     * ALTERERD THE CREATE TABLE QUERY
     *
     * The create table query is now creating the table with 2 additional columns:
     *
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryString = "CREATE TABLE " +
                ...
                Contract.TABLE_TODO.COLUMN_NAME_ISCOMPLETED + " INTEGER DEFAULT 0" +
                "); ";
